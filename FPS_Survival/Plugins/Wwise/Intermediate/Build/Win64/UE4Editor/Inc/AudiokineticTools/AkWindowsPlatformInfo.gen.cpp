...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAkWin32PlatformInfo_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAkWin32PlatformInfo_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAkWin32PlatformInfo_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAkWin32PlatformInfo, 3366305417);
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAkWin64PlatformInfo_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAkWin64PlatformInfo_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAkWin64PlatformInfo_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAkWin64PlatformInfo, 2844578869);
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAkWindowsPlatformInfo_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAkWindowsPlatformInfo_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAkWindowsPlatformInfo_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAkWindowsPlatformInfo, 410086463);
