...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAkSwitchInitializationSettings_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAkSwitchInitializationSettings_MigrateMultiCoreRendering, "MigrateMultiCoreRendering" }, // 92342619
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAkSwitchInitializationSettings_Statics::NewProp_CommunicationSettings = { "CommunicationSettings", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkSwitchInitializationSettings, CommunicationSettings), Z_Construct_UScriptStruct_FAkCommunicationSettingsWithCommSelection, METADATA_PARAMS(Z_Construct_UClass_UAkSwitchInitializationSettings_Statics::NewProp_CommunicationSettings_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAkSwitchInitializationSettings_Statics::NewProp_CommunicationSettings_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAkSwitchInitializationSettings, 1771134066);
