...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAkAudioBank_Statics::NewProp_CurrentLocalizedPlatformAssetData = { "CurrentLocalizedPlatformAssetData", nullptr, (EPropertyFlags)0x0040000000002000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkAudioBank, CurrentLocalizedPlatformAssetData), Z_Construct_UClass_UAkAssetPlatformData_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAkAudioBank_Statics::NewProp_CurrentLocalizedPlatformAssetData_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAkAudioBank_Statics::NewProp_CurrentLocalizedPlatformAssetData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UAkAudioBank_Statics::NewProp_LocalizedPlatformAssetDataMap = { "LocalizedPlatformAssetDataMap", nullptr, (EPropertyFlags)0x0014000000020001, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkAudioBank, LocalizedPlatformAssetDataMap), METADATA_PARAMS(Z_Construct_UClass_UAkAudioBank_Statics::NewProp_LocalizedPlatformAssetDataMap_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAkAudioBank_Statics::NewProp_LocalizedPlatformAssetDataMap_MetaData)) };
	...
	IMPLEMENT_CLASS(UAkAudioBank, 2180892463);
