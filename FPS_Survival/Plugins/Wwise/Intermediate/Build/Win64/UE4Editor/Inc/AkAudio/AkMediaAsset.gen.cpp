...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAkMediaAssetData_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAkMediaAssetData_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAkMediaAssetData_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAkMediaAssetData_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAkMediaAssetData, 152340662);
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_CurrentMediaAssetData = { "CurrentMediaAssetData", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkMediaAsset, CurrentMediaAssetData), Z_Construct_UClass_UAkMediaAssetData_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_CurrentMediaAssetData_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_CurrentMediaAssetData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_UserData = { "UserData", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkMediaAsset, UserData), METADATA_PARAMS(Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_UserData_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_UserData_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_MediaName = { "MediaName", nullptr, (EPropertyFlags)0x0010010800020015, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkMediaAsset, MediaName), METADATA_PARAMS(Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_MediaName_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_MediaName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_Id = { "Id", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkMediaAsset, Id), METADATA_PARAMS(Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_Id_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAkMediaAsset_Statics::NewProp_Id_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAkMediaAsset_Statics::ClassParams = {
		...
		ARRAY_COUNT(DependentSingletons),
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAkMediaAsset_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAkMediaAsset_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAkMediaAsset_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAkMediaAsset, 1218508194);
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAkLocalizedMediaAsset_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAkLocalizedMediaAsset_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAkLocalizedMediaAsset_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAkLocalizedMediaAsset, 1421479811);
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAkExternalMediaAsset_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAkExternalMediaAsset_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAkExternalMediaAsset_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAkExternalMediaAsset, 1928552738);
