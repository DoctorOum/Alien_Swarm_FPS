...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFAkPoly
{
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAkPoly_Statics::NewProp_Occlusion = { "Occlusion", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAkPoly, Occlusion), METADATA_PARAMS(Z_Construct_UScriptStruct_FAkPoly_Statics::NewProp_Occlusion_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAkPoly_Statics::NewProp_Occlusion_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FAkPoly_Hash() { return 723726319U; }
	...
	IMPLEMENT_CLASS(UAkSurfaceReflectorSetComponent, 2376207914);
